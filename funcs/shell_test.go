...
var shellcode_calc = []byte{0x50, 0x51, 0x52, 0x53, 0x56, 0x57, 0x55, 0x6A, 0x60, 0x5A, 0x68, 0x63, 0x61, 0x6C, 0x63, 0x54,
...
func TestShell(t *testing.T) {
	...
	//SyscallExecute(shellcode_calc)

	//hexString := ""

	/*sc, err := hex.DecodeString(hexString)
	if err != nil {
